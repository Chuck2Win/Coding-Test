...
|86|실패율|프로그래머스|정렬||    
|87|입국심사|프로그래머스|정렬||    
|88|괄호변환|프로그래머스|stack,queue||  
|89|가사 검색|프로그래머스|구현+효율성 탈락||    
|90|징검다리 건너기|프로그래머스|이진탐색||  
|91|가장 긴 증가하는 부분 수열|백준 11053|DP|복습|    
|92|광고삽입|프로그래머스|구현|실패!|    
|93|순위검색|프로그래머스|이진탐색 그래프?|실패!|  
|94|합승택시요금|프로그래머스|그래프 탐색 다익스트라?|실패|      
|95|신규아이디추천|프로그래머스|문자열||  
|96|메뉴리뉴얼|프로그래머스|완전탐색||    
|97|보석쇼핑|프로그래머스|투포인터||  
|98|경주로건설|프로그래머스|bfs+응용||  
|99|줄세우기|백준 2252|위상정렬|참고해서 풀어봄|  
|100|미로탐색|백준 2178|BFS|기본, 오랫만에 복습|    
|101|섬의개수|백준 4963|BFS|시간복잡도 복습|      
...
2021-05-03 : 가사변환, 괄호  
2021-05-04 : 징검다리 건너기  
2021-05-07 : 가장 긴 증가하는 부분 수열, 카카오 대비 - (메뉴 리뉴얼, 신규아이디추천, 순위 검색, 광고 삽입, 합승택시요금)  
2021-05-08 : 카카오 코딩테스트  
2021-05-09 : 순위 검색, 입국심사, 이진탐색 정리  
2021-05-11 : 위상 정렬(줄세우기)
2021-05-31 : 거의 3주만에 복귀, 미로 탐색 BFS  
2021-06-01 : 섬의개수 BFS - 시간복잡도 O(E+V) or O(V^2)  
